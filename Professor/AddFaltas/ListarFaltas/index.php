...
<body class="dark">
    ...
    <section class="home">
        ...
        <div class="homi">
            ...
            <form id="FormFaltas" method="post">
               ...
               <h4 class="aa" style="color: #ffffff;">Inserir Faltas</h4>   
                ...
                <div class="form__group field" style="padding-top: 50px;">
                    ...
                    <select class="form__field" id="presenca" name="presenca" required>
                        <option value="1" style="background-color: #b20000;">1</option>
                        <option value="2" style="background-color: #b20000;">2</option>
                        <option value="3" style="background-color: #b20000;">3</option>
                        <option value="4" style="background-color: #b20000;">4</option>
                    </select>
                </div>
...
<div class="blure">
  <div id="buttons">
    <button class="bn5" id="Mostra">Add Faltas</button>
