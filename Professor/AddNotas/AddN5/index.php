    ...
    if ($row == 0) {
        ...
        <form id="FormNotas" action = "cadastrar.php" method="post">
            ...
            while ($Alunos = mysqli_fetch_array($resultado_Alunos)) {
                ?>
                <div class='tab'>
                    <h4 class='aa' style='color: #ffffff;'>Inserir notas 5</h4>
                    ...
                    <div class='form__group field' style='display: flex;'>
                        <div class='form__field' style='flex: 1;'>
                            <input type='date' class='form__input' name="dataN5[]"     placeholder='Data da N5' required>
                            <label for='name' class='form__label'>Data N5</label>
                        </div>

                        <div class='form__field' style='flex: 1;'>
                        <input type='hidden' name='raAluno[]' value='<?= $Alunos['RA'] ?>'>
                        <input type='hidden' name='idTurma' value='<?= $idTurma ?>'>
                            <input type='number' class='form__input' name="notas_5[]" placeholder='Nota da N5' required>
                            <label for='name' class='form__label'>Nota N5</label>
                        </div>
