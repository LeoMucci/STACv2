    ...
    if ($row == 0) {
        ...
        <form id="FormNotas" action = "cadastrar.php" method="post">
            ...
            while ($Alunos = mysqli_fetch_array($resultado_Alunos)) {
                ?>
                <div class='tab'>
                    <h4 class='aa' style='color: #ffffff;'>Inserir notas N2</h4>
                    ...
                    <div class='form__group field' style='display: flex;'>
                        <div class='form__field' style='flex: 1;'>
                            <input type='date' class='form__input' name="dataN2[]"     placeholder='Data da N2' required>
                            <label for='name' class='form__label'>Data N2</label>
                        </div>

                        <div class='form__field' style='flex: 1;'>
                        <input type='hidden' name='raAluno[]' value='<?= $Alunos['RA'] ?>'>
                        <input type='hidden' name='idTurma' value='<?= $idTurma ?>'>
                            <input type='number' class='form__input' name="notas_n2[]" placeholder='Nota da N2' required>
                            <label for='name' class='form__label'>Nota N2</label>
                        </div>
